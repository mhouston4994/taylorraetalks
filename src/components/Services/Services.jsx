...
const Services = () => {
  ...
  const serviceInfo = [
    ...
    desc: `his longer Tarot session allows us to go deeper into one area of your life or explore multiple. These spreads are typically 12-14 cards, although I will pull clarifying cards as needed. I will also end with an Oracle pull.
        ...
        <div className="project-wrapper">
          <Title title="Services" />
            <div className="serviceContainer">
              {serviceInfo.map(x=>{
                return(
                <Card name={x.name} desc={x.desc}></Card>
                )
              })}
